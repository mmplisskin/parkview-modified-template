        ...
        <article class="page-block">
            ...
            <div class="grid">
                <div class="unit two-thirds">
                    <!-- CAROUSEL -->
                    <div id="full-carousel" class="owl-carousel full-carousel">
                        <!-- Image -->
                        <div>
                    ...
                    <p>Non nulla summis nam nostrud. Summis possumus quo officia. Ex de efflorescere. Arbitror eu anim. E multos pariatur imitarentur aut o esse varias ut probant. Occaecat dolor mandaremus ingeniis in ab labore o noster. Doctrina in nescius non varias proident incididunt se nam pariatur quo laboris, ea quem ipsum aute possumus.
                    </p>
                    ...
                    <div id="accordion-container">
                        <!-- ITEM 1 -->
                        <div class="accordion-header">Vestibulum porta, tortor elementum luctus dictum</div>
                        ...
                        <!-- ITEM 2 -->
                        <div class="accordion-header">Est odio egestas justo</div>
                        <div class="accordion-content">
                            <p>Vestibulum porta, tortor elementum luctus dictum, est odio egestas justo, dapibus aliquet sem nisl vel augue. Fusce eu sapien tortor, a consequat nunc. Nunc pulvinar consequat turpis, sed vulputate nibh lacinia rutrum. Nam laoreet pulvinar eros, sit amet sodales est venenatis eu. Fusce eu sapien tortor, a consequat nunc. Nunc pulvinar consequat turpis, sed vulputate nibh lacinia rutrum.</p>
                        </div>
                        <!-- ITEM 3 -->
                        <div class="accordion-header">Tortor elementum luctus dictum</div>
                        <div class="accordion-content">
                            <p>Vestibulum porta, tortor elementum luctus dictum, est odio egestas justo, dapibus aliquet sem nisl vel augue. Fusce eu sapien tortor, a consequat nunc. Nunc pulvinar consequat turpis, sed vulputate nibh lacinia rutrum. Nam laoreet pulvinar eros, sit amet sodales est venenatis eu. Fusce eu sapien tortor, a consequat nunc. Nunc pulvinar consequat turpis, sed vulputate nibh lacinia rutrum.</p>
                        </div>
                        <!-- ITEM 4 -->
                        <div class="accordion-header">Dapidus dio egestas justo</div>
                        <div class="accordion-content">
                            <p>Vestibulum porta, tortor elementum luctus dictum, est odio egestas justo, dapibus aliquet sem nisl vel augue. Fusce eu sapien tortor, a consequat nunc. Nunc pulvinar consequat turpis, sed vulputate nibh lacinia rutrum. Nam laoreet pulvinar eros, sit amet sodales est venenatis eu. Fusce eu sapien tortor, a consequat nunc. Nunc pulvinar consequat turpis, sed vulputate nibh lacinia rutrum.</p>
                        </div>
                    </div>
                    <p>An et summis minim aute non se singulis praetermissum, quamquam cillum occaecat laboris, labore senserit do tractavissent. Ne sint ingeniis incurreret iis quo noster doctrina cupidatat. Summis iudicem in probant, quibusdam irure summis ea eram. Velit qui laborum ubi fore.
                    </p>
                </div>
                <!-- SIDEBAR -->
                <aside class="unit one-third">
                    ...
                    <div class="sidebar-box">
                        ...
                        <ul class="sidebar-list">
                            ...
                            <li>
                                <a href="#">Radiology Services</a>
                            </li>
                            <li>
                                <a href="#">Electrocardiography Services</a>
                            </li>
                            <li>
                                <a href="#">Pharmacy</a>
                            </li>
                            <li>
                                <a href="#">Exotic Animals</a>
                            </li>
                        </ul>
                    </div>
                </aside>
