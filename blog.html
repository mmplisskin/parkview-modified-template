        ...
        <section class="page-block">
            ...
            <div class="grid">
                <div class="unit whole">
                    ...
                    <article class="blogcontainer">
                        <!-- POST IMAGE -->
                        <div class="blogimage" data-image="images/photos/post5.jpg">
                            <a href="single-post.html"></a>
                        </div>
                        <!-- POST CONTENT -->
                        <div class="postcontent">
                            <h4><a href="single-post.html">Ullamco praesentibus</a></h4>
                            <p class="postdate">14 October 2014, by John Doe</p>
                            <hr/>
